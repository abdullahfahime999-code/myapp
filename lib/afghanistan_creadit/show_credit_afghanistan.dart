...
import '../afghanistan_creadit/order_credit_afghanistan.dart';

class ShowCreditAfghanistanPage extends StatefulWidget {
  final String operatorName;
  final String phoneNumber;

  const ShowCreditAfghanistanPage({
    super.key,
  ...
  @override
  State<ShowCreditAfghanistanPage> createState() =>
      _ShowCreditAfghanistanPageState();
}

class _ShowCreditAfghanistanPageState extends State<ShowCreditAfghanistanPage> {
  ...
  Future<void> _loadCreditPrice() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(api('/api/credits/afghanistan')),
        headers: {
