...
class OrderCreditAfghanistanPage extends StatefulWidget {
  ...
  const OrderCreditAfghanistanPage({
    super.key,
  ...
  @override
  State<OrderCreditAfghanistanPage> createState() =>
      _OrderCreditAfghanistanPageState();
}

class _OrderCreditAfghanistanPageState
    extends State<OrderCreditAfghanistanPage> {
  ...
  Future<void> _submitOrder() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(api('/api/orders/create_credit')),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${widget.amount} واحد شارژ برای شماره ${widget.phoneNumber} ثبت شد',
                style: TextStyle(
                  fontSize: 14,
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    _isLoading
                        ? 'در حال ثبت...'
                        : 'تایید و خرید کریدیت (${widget.totalPrice.toStringAsFixed(0)} تومان)',
                    style: const TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                    ),
