...
import 'order_likee_credit.dart';

class ShowLikeeCreditPage extends StatefulWidget {
  final String likeeId;

  const ShowLikeeCreditPage({
    super.key,
    required this.likeeId,
  });

  @override
  State<ShowLikeeCreditPage> createState() => _ShowLikeeCreditPageState();
}

class _ShowLikeeCreditPageState extends State<ShowLikeeCreditPage> {
  ...
  Future<void> _loadPackages() async {
    ...
    try {
      String url = api('/api/products/games?category=likee');
                        ...
                        : RefreshIndicator(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return _LikeePackageCard(
                                  package: package,
                                  likeeId: widget.likeeId,
                                );
                              },
                            ),
                          ),
...
// 📌 کارت الماس لایکی
// ============================================
class _LikeePackageCard extends StatelessWidget {
  final Map<String, dynamic> package;
  final String likeeId;

  const _LikeePackageCard({
          ...
          child: InkWell(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => OrderLikeeCreditPage(
                    packageName: name,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(12),
                      child: Image.asset(
                        'assets/images/operators/likee.png',
                        width: imageSize,
                        height: imageSize,
                        fit: BoxFit.contain,
                        errorBuilder: (context, error, stackTrace) {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          description.isNotEmpty ? description : 'الماس لایکی',
                          style: TextStyle(
