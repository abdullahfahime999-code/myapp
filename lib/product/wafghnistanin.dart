...
class OperatorDetectorPage extends StatefulWidget {
  const OperatorDetectorPage({super.key});

  @override
  State<OperatorDetectorPage> createState() => _OperatorDetectorPageState();
}

class _OperatorDetectorPageState extends State<OperatorDetectorPage> {
              ...
              child: Row(
                ...
                children: _operators.map((op) {
                  ...
                  return _OperatorLogoItem(
                    ...
                    color: op['color'],
                    onTap: () {
                      // با کلیک روی لوگو، شماره نمونه وارد میشود
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                  ...
                  if (_operatorName == 'اپراتور نامشخص' || _operatorName.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('شماره وارد شده معتبر نیست. لطفاً شماره صحیح را وارد کنید'),
                        backgroundColor: Colors.red,
                        behavior: SnackBarBehavior.floating,
                      ),
                    );
        ...
        children: [
          Stack(
            ...
            children: [
              ...
              // ✅ تیک سبز برای اپراتور انتخاب شده
              if (isSelected)
                Positioned(
                  top: -4,
                  right: -4,
