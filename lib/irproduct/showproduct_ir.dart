...
import 'orderproduct_ir.dart'; // ✅ import صفحه سفارش ایران

class ShowProductIranPage extends StatefulWidget {
  final String operatorName;
  final String phoneNumber;

  const ShowProductIranPage({
    super.key,
  ...
  @override
  State<ShowProductIranPage> createState() => _ShowProductIranPageState();
}

class _ShowProductIranPageState extends State<ShowProductIranPage> {
  ...
  Future<void> _loadPackages() async {
    ...
    try {
      String url = api('/api/packages/iran');
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          // ✅ بدون فیلتر - نمایش همه بسته‌های ایران
          setState(() {
...
// ============================================
// 📌 کارت بسته با ناوبری به صفحه سفارش (ایران)
// ============================================
class _PackageCardIran extends StatelessWidget {
  final Map<String, dynamic> package;
  final String operatorImage;
  final String operatorName;
  final String phoneNumber;

  const _PackageCardIran({
          ...
          child: InkWell(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => OrderProductIranPage(
                    package: package,
