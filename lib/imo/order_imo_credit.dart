...
class OrderImoCreditPage extends StatefulWidget {
  final String imoId;
  final double totalPrice;
  final String packageName;
  final String description;

  const OrderImoCreditPage({
    super.key,
    required this.imoId,
  ...
  @override
  State<OrderImoCreditPage> createState() => _OrderImoCreditPageState();
}

class _OrderImoCreditPageState extends State<OrderImoCreditPage> {
  ...
  void initState() {
    super.initState();
    _imoIdController.text = widget.imoId;
  }
  ...
  Future<void> _submitOrder() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(api('/api/orders/create_imo_credit')),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
        body: json.encode({
          'imo_id': _imoIdController.text.trim(),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'سفارش الماس ایمو با موفقیت ثبت شد',
                style: TextStyle(
                  fontSize: 22,
                  fontWeight: FontWeight.bold,
                  color: Color(0xFF0E8A4D),
              ...
              Text(
                'بسته ${widget.packageName} برای ایدی ${_imoIdController.text.trim()} ثبت شد',
                style: TextStyle(
                  fontSize: 14,
  ...
  Widget build(BuildContext context) {
    ...
    final String imoId = _imoIdController.text.trim();

    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'تایید سفارش الماس ایمو',
          style: TextStyle(
            fontWeight: FontWeight.bold,
            fontSize: 20,
          ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      widget.description.isNotEmpty ? widget.description : 'الماس ایمو',
                      style: const TextStyle(
                        fontSize: 14,
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'لطفاً ایدی ایمو را وارد کنید';
                  }
                  if (value.trim().length < 4) {
                    return 'ایدی ایمو باید حداقل ۴ کاراکتر باشد';
                  }
                  return null;
                },
              ),
