...
import 'show_credit_iran.dart';

class IranCreditDetectorPage extends StatefulWidget {
  const IranCreditDetectorPage({super.key});

  @override
  State<IranCreditDetectorPage> createState() =>
      _IranCreditDetectorPageState();
}

class _IranCreditDetectorPageState extends State<IranCreditDetectorPage> {
  ...
  final List<Map<String, dynamic>> _operators = [
    ...
    },
    {
      ...
      'prefixes': [
        '091', '093', '0990', '0991', '0992', '0993', '0994', '0995', '0996', '0997', '0998', '0999'
      ],
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // ============================================
            // 📌 دکمه تایید - رفتن به صفحه کریدیت ایران
            // ============================================
            SizedBox(
              width: double.infinity,
              child: ElevatedButton.icon(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ShowCreditIranPage(
