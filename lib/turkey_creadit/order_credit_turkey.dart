...
class OrderCreditTurkeyPage extends StatefulWidget {
  ...
  @override
  State<OrderCreditTurkeyPage> createState() =>
      _OrderCreditTurkeyPageState();
}

class _OrderCreditTurkeyPageState
    extends State<OrderCreditTurkeyPage> {
  ...
  Future<void> _submitOrder() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(api('/api/orders/create_credit_turkey')),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'سفارش کریدیت ترکیه با موفقیت ثبت شد',
                style: TextStyle(
                  fontSize: 22,
                  fontWeight: FontWeight.bold,
                  color: Color(0xFF0E8A4D),
              ...
              Text(
                '${widget.amount} لیر شارژ برای شماره ${widget.phoneNumber} ثبت شد',
                style: TextStyle(
                  fontSize: 14,
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    _isLoading
                        ? 'در حال ثبت...'
                        : 'تایید و خرید کریدیت ترکیه (${widget.totalPrice.toStringAsFixed(0)} تومان)',
                    style: const TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                    ),
