...
class OrderPubgCreditPage extends StatefulWidget {
  final String pubgId;
  final double totalPrice;
  final String packageName;
  final String description;  // ✅ اضافه شد

  const OrderPubgCreditPage({
    super.key,
    required this.pubgId,
    required this.totalPrice,
    required this.packageName,
    required this.description,  // ✅ اضافه شد
  });

  @override
  State<OrderPubgCreditPage> createState() => _OrderPubgCreditPageState();
}

class _OrderPubgCreditPageState extends State<OrderPubgCreditPage> {
  ...
  void initState() {
    super.initState();
    _pubgIdController.text = widget.pubgId;
  }
  ...
  Future<void> _submitOrder() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(api('/api/orders/create_pubg_credit')),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
        body: json.encode({
          'pubg_id': _pubgIdController.text.trim(),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'سفارش یوسی پابجی با موفقیت ثبت شد',
                style: TextStyle(
                  fontSize: 22,
                  fontWeight: FontWeight.bold,
                  color: Color(0xFF0E8A4D),
              ...
              Text(
                'بسته ${widget.packageName} برای ایدی ${_pubgIdController.text.trim()} ثبت شد',
                style: TextStyle(
                  fontSize: 14,
  ...
  Widget build(BuildContext context) {
    ...
    final String pubgId = _pubgIdController.text.trim();
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: const Color(0xFFE65100).withOpacity(0.20),
                              width: 1.5,
                            ),
                          ),
                          child: ClipRRect(
                    ...
                    const SizedBox(height: 4),
                    Text(
                      widget.description.isNotEmpty ? widget.description : 'یوسی پابجی',
                      style: const TextStyle(
                        fontSize: 14,
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'لطفاً ایدی پابجی را وارد کنید';
                  }
                  if (value.trim().length < 4) {
                    return 'ایدی پابجی باید حداقل ۴ کاراکتر باشد';
                  }
                  return null;
                },
              ),
              ...
              Row(
                children: [
                  ...
                  Text(
                    'یوسی به این ایدی ارسال خواهد شد',
                    style: TextStyle(
                      fontSize: 12,
                      color: Colors.grey[500],
                    ),
