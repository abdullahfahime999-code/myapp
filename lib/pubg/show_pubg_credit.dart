...
import 'order_pubg_credit.dart';

class ShowPubgCreditPage extends StatefulWidget {
  final String pubgId;

  const ShowPubgCreditPage({
    super.key,
    required this.pubgId,
  });

  @override
  State<ShowPubgCreditPage> createState() => _ShowPubgCreditPageState();
}

class _ShowPubgCreditPageState extends State<ShowPubgCreditPage> {
  ...
  Future<void> _loadPackages() async {
    ...
    try {
      String url = api('/api/products/games?category=pubg');
                        ...
                        : RefreshIndicator(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return _PubgPackageCard(
                                  package: package,
                                  pubgId: widget.pubgId,
                                );
                              },
                            ),
                          ),
...
// ============================================
// 📌 کارت یوسی پابجی (بدون amount)
// ============================================
class _PubgPackageCard extends StatelessWidget {
  final Map<String, dynamic> package;
  final String pubgId;

  const _PubgPackageCard({
          ...
          child: InkWell(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => OrderPubgCreditPage(
                    packageName: name,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(12),
                      child: Image.asset(
                        'assets/images/operators/pubg.png',
                        width: imageSize,
                        height: imageSize,
                        fit: BoxFit.contain,
                        errorBuilder: (context, error, stackTrace) {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          description.isNotEmpty ? description : 'یوسی پابجی',
                          style: TextStyle(
